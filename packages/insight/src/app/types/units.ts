import { DVT, BTC, Chain, tDVT, tBTC } from './chains';
...
export const DVTDenomination = generateBitcoinDenomination(DVT);
export const tDVTDenomination = generateBitcoinDenomination(tDVT);
